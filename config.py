...
mode_arg.add_argument('--num_samples', type=int, default=2700,
...
mode_arg.add_argument('--shuffle', type=str2bool, default=False,
...
misc_arg.add_argument('--data_dir', type=str, default='D:\\works\\tsne-viz',
                        help='Directory where data is stored')
misc_arg.add_argument('--plot_dir', type=str, default='D:\\works\\tsne-viz',
